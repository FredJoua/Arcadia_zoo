...
include_once("../dbconn.php");
    ...
    // Requête pour récupérer les animaux appartenant à l'habitat "Marais" avec une seule image par animal
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="jumbotron bg-cover text-white mb-0" style="background-image: url(../img/bg_tropicale.jpg); background-size: cover; background-repeat: no-repeat; background-position: center; height: 30vh; position: relative;">
            <div class="container py-5" style="position: absolute; bottom: 0; left: 50px; background-color: rgba(11, 149, 244, 0.6); padding: 15px;">
                <h1 class="display-4 font-weight-bold">Habitats Marais</h1>
            </div>
        </div>
    </div>
