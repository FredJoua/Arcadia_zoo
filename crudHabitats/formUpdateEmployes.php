        ...
        <div class="row justify-content-center">
            <div class="col-md-5 mt-3">
                ...
                <form action="formUpdateEmployes.php" method="post">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <input class="form-control" type="date" name="date_repas_pris" placeholder="Date repas pris" value="<?php echo htmlspecialchars($date_repas_pris); ?>">
                        </div>
                        <div class="col mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <a href="tableLisitingRapportVeterinaires.php" class="btn btn-outline-danger">Annuler</a>
                        </div>
                    </div>
                </form>
