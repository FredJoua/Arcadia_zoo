                    ...
                    <form method="post">
                        ...
                        <div class="form-row">
                            <div class="col-lg-10">                                
                                ...
                                <input type="time" name="ouverture" id="ouverture" placeholder="Heure d'ouverture" class="form-control my-3 p-3" >
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-lg-10">                                
                                ...
                                <input type="time" name="fermeture" id="fermeture" placeholder="Heure de fermeture" class="form-control my-3 p-3" >
                            </div>
                        </div>
